...
EditorLayer::EditorLayer(const std::function<void(bool)> &renderFn) : m_RenderFn(renderFn), m_FramebufferTexture(1920, 1080) {
}
...
void EditorLayer::OnUpdate() {
    if (ImGui::IsMouseClicked(0))
    {
        ...
        glReadPixels(mousePosX, 1080-mousePosY, 1, 1, GL_RGBA, GL_UNSIGNED_BYTE, data);
