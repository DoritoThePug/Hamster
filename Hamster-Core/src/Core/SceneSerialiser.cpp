        ...
        while(in.read(reinterpret_cast<char*>(&componentId), sizeof(componentId))) {
            ...
            switch (componentId) {
                case Transform_ID: {
                    ...
                    std::cout << pos.x << " " << pos.y << " " << rotation << " " << size.x << " " << size.y << std::endl;
                ...
                case Sprite_ID: {
                    ...
                    m_Scene->AddEntityComponent<Sprite>(uuid, textureName, AssetManager::GetTexture(textureName), colour);
                ...
                case Rigidbody_ID: {
                    Physics::CreateBody(m_Scene->GetWorldId(), b2_dynamicBody, m_Scene->GetEntity(uuid), m_Scene->GetRegistry());
